...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexSiege = /^\/siege/;
      botRegexCD = /^\/How's everyone in the North doing/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    else if(request.text && botRegexCD.test(request.text)) {
    this.res.writeHead(200);
    postMessage("Everyone in the North is doing a great job except Cody");
    this.res.end();
  }
  else {
